...
async function main() {
  ...
  // ================= Slide 12: Section divider - 後半 =================
  {
    const md = load("12-part2-divider.md");
    const s = pres.addSlide();
    darkBg(s);
    s.addShape(pres.ShapeType.ellipse, {
      x: -2.5,
  ...
  // ================= Slide 13: AIは開発だけじゃない =================
  {
    const md = load("13-beyond-development.md");
    const s = pres.addSlide();
    lightBg(s);
    kicker(s, md.kicker);
    title(s, md.title);
