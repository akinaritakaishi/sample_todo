...
**UIの見た目や挙動に影響する変更**（表示の追加・変更、色分け、レイアウト、操作フローの変更など）の場合は、`run`スキルを使って実際にアプリを起動し、修正後の画面のスクリーンショットを撮影してユーザーに提示してください。可能なら以下も一緒に確認・提示すると手戻りが減ります。
